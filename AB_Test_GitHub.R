...
dwell.time.versionA <- read.csv("C:/Users/muckam/Desktop/DataScienceBootcamp/Datasets/Dwell_Time/Dwell_Time_VersionA.csv")
dwell.time.versionB <- read.csv("C:/Users/muckam/Desktop/DataScienceBootcamp/Datasets/Dwell_Time/Dwell_Time_VersionB.csv")
